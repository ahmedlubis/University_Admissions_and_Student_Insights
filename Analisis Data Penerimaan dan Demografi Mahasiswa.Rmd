---
title: "Analisis Data Penerimaan dan Demografi Mahasiswa"
author: "AhmedLubis"
date: "2026-06-09"
...
1. Anomali Data
registrasi mengandung nilai NA dan MENGUNDURKAN_DIRI.
Format tanggal tidak konsisten.
Data pada aktivitas-perkuliahan.csv masih teragregasi (dipisahkan ;).

2. Asumsi Pembersihan
Pendaftar unik berdasarkan email per tahun.
Mahasiswa internasional diidentifikasi dari asal kota/sekolah luar negeri.
IPK dihitung dari konversi nilai huruf ke skala 4.
Masa studi dihitung dari tahun pendaftaran hingga tahun wisuda.
...
Bukti: Pendaftar naik 3.754 → 6.518 (2022–2026), accept rate turun 53% → 47%.
